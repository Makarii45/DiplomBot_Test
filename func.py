...
import psycopg2
import datetime
from conf import bot_token, acces_token, db_user, db_pass, db_name
from vk_api.longpoll import VkLongPoll, VkEventType
from db import insert_user, insert_result_user, get_user_db_id, check_result_user, delete_tables
